        ...
        @forelse ($bookings as $booking)
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @else
                        <div class="text-sm text-gray-500 italic">Belum Check-In</div>
                    @endif
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="fixed inset-0 z-50 overflow-hidden flex items-center my-4 justify-center px-4 sm:px-6"
                                ...
                                <div class="bg-white rounded-lg shadow-xl overflow-auto w-full overflow-auto max-h-full flex flex-col text-left max-w-4xl"
                                    ...
                                    <div
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Silakan verifikasi kondisi kamar dan selesaikan proses check-out</p>
                                        ...
                                        <div x-show="isLateCheckout" class="mt-2 flex items-center text-red-600">
                                            ...
                                            <span class="text-sm font-medium">Check-out terlambat! Tamu telah melewati waktu check-out yang dijadwalkan.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-1 overflow-y-auto px-6 py-6">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div class="bg-gray-50 p-4 rounded-lg">
                                                ...
                                                <div class="space-y-3">
                                                    <div class="flex justify-between">
                                                        <span class="text-sm font-medium text-gray-600">ID Pesanan:</span>
                                                        <span class="text-sm text-gray-800"
                                                            x-text="bookingDetails.order_id"></span>
                                                    </div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm font-medium text-gray-600">Tanggal Check-In:</span>
                                                        <span class="text-sm text-gray-800"
                                                            x-text="bookingDetails.check_in"></span>
                                                    </div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm font-medium text-gray-600">Tanggal Check-Out:</span>
                                                        <span class="text-sm text-gray-800"
                                                            x-text="bookingDetails.check_out"></span>
                                                    </div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm font-medium text-gray-600">Nama Tamu:</span>
                                                        <span class="text-sm text-gray-800"
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-4">
                                                    <p class="text-sm text-gray-600 mb-3">Periksa semua barang yang hilang atau rusak:</p>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        ...
                                                        <label for="select-all-items"
                                                            class="ml-2 block text-sm font-medium text-gray-700">Pilih Semua</label>
                                                    </div>
                                                ...
                                                <div class="mt-4" x-show="hasDamagedItems">
                                                    <label class="block text-sm font-medium text-gray-700">Biaya Kerusakan</label>
                                                    <div class="mt-1 relative rounded-md shadow-sm">
                                                        ...
                                                        <div class="absolute inset-y-0 right-0 flex items-center">
                                                            <label for="currency" class="sr-only">Mata Uang</label>
                                                        </div>
                                                    </div>
                                                    <p class="mt-1 text-sm text-gray-500" x-show="damageCharges > 0">
                                                        Jumlah ini akan dipotong dari deposit keamanan.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
