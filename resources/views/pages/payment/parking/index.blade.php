<x-app-layout>
    ...
    <script>
        ...
        function showParkingStatusBadge(status, parkingInfoStr) {
        ...
        document.getElementById('add_order_id')?.addEventListener('change', function() {
            ...
            if (this.value && selectedOption.dataset.userName) {
                ...
                showParkingStatusBadge(selectedOption.dataset.parkingStatus || 'new', selectedOption.dataset.parkingInfo || '');
