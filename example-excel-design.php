...
try {
    ...
    // 4. FILTER SECTION
    echo "4. Adding filter information...\n";
    $filters = [
    ...
    // 6. SAMPLE DATA with Zebra Striping
    echo "6. Adding sample data...\n";
    $sampleData = [
