...
class CustomerController extends Controller
{
    ...
    private function getCustomersQuery($search = null, $registrationStatus = null, $propertyId = null, $bookingStatus = null)
    {
        ...
        $registeredUsers = User::select([
            ...
            DB::raw('(SELECT t_booking.status FROM t_booking INNER JOIN t_transactions t7 ON CONVERT(t_booking.order_id USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(t7.order_id USING utf8mb4) COLLATE utf8mb4_unicode_ci WHERE t7.user_id = users.id ORDER BY t7.transaction_date DESC LIMIT 1) as current_booking_status'),
        ...
        $guestCustomers = Transaction::select([
            ...
            DB::raw('(SELECT t_booking.status FROM t_booking INNER JOIN t_transactions t7 ON CONVERT(t_booking.order_id USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(t7.order_id USING utf8mb4) COLLATE utf8mb4_unicode_ci WHERE CONVERT(t7.user_email USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(t_transactions.user_email USING utf8mb4) COLLATE utf8mb4_unicode_ci AND t7.user_id IS NULL ORDER BY t7.transaction_date DESC LIMIT 1) as current_booking_status'),
