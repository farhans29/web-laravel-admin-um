...
class NewReservController extends Controller
{
    public function index(Request $request)
    {
        $query = Booking::with(['user', 'room', 'property', 'transaction'])
            ...
            ->orderByDesc('created_at'); // Menggunakan created_at sebagai pengurutan default
        ...
        // Filter berdasarkan rentang tanggal pembuatan (created_at)
    ...
    public function filter(Request $request)
    {
        ...
        // Date range filter berdasarkan created_at
        if ($request->filled('start_date') && $request->filled('end_date')) {
